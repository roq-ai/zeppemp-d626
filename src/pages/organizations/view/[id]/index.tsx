...
import { deleteGuestById, createGuest } from 'apiSdk/guests';
...
function OrganizationViewPage() {
  ...
  const guestHandleCreate = async () => {
    setCreateError(null);
    try {
      await createGuest({ organization_id: id, user_id: guestUserId });
      setGuestUserId(null);
      await mutate();
    } catch (error) {
            ...
            <Box>
              <Stack spacing={2} mb={8}>
                ...
                <Flex gap={5} alignItems="flex-end">
                  <Box flex={1}>
                    <UserSelect name={'guest_user'} value={guestUserId} handleChange={setGuestUserId} />
                  </Box>
                  <Button colorScheme="blue" mt="4" mr="4" onClick={guestHandleCreate} isDisabled={!guestUserId}>
                    Create
                  </Button>
                </Flex>
                <TableContainer>
